...
`evaluations/dd/runners/batch_runner.py:180-231 `; `evaluations/dd/README.md:9-12 `
...
`evaluations/dd/scorers/init.py:1-16 `; `evaluations/dd/scorers/oracle_chem.py:6-11 `
...
`evaluations/dd/tasks_batch/C1_chemical_data_preprocessing/tech_01_hard_TPSA.json:2-18 `; `evaluations/dd/registry.py:73-86 `; `evaluations/dd/README.md:87-101 `
...
`evaluations/dd/scorers/data/failure_modes.json:17-18 `; `evaluations/dd/scorers/data/answer_pool.json:1-107 `
...
`evaluations/dd/scorers/data/answer_pool.json:79-85 `
...
`evaluations/dd/scorers/oracle_budget.py:147-153 `; `evaluations/dd/scorers/oracle_budget.py:109-123 `
...
`evaluations/dd/scorers/guacamol_goal_scorer.py:73-74 `; `evaluations/dd/runners/design_runner.py:292-339 `
...
`evaluations/dd/scorers/oracle_regulator.py:1297-1310 `
...
`evaluations/dd/scorers/oracle_validity.py:266-335 `
...
`evaluations/dd/scorers/mpo_scorer.py:10-22 `
...
`evaluations/dd/scorers/valsartan_smarts_scorer.py:241-244 `
...
`evaluations/dd/scorers/oracle_chem.py:139-148 `; `evaluations/dd/scorers/oracle_chem.py:106-160 `
...
`evaluations/dd/scorers/oracle_chem.py:383-395 `
...
`evaluations/dd/runners/design_runner.py:255-289 `
...
`evaluations/dd/registry.py:30-33 `; `evaluations/dd/registry.py:36-52 `
...
`evaluations/dd/runners/batch_runner.py:53-90 `; `evaluations/dd/examples/agent_mw.py:16-25 `; `evaluations/dd/README.md:77-83 `
...
`evaluations/dd/runners/notebook_runner.py:81-123 `; `evaluations/dd/runners/notebook_runner.py:307-357 `
...
`front_web/templates/pipeline_evaluator.py:714-730 `; `front_web/templates/pipeline_evaluator.py:728-730 `
...
`front_web/src/lib/judge-service.js:277-292 `; `front_web/templates/pipeline_evaluator.py:857-858 `
...
`front_web/templates/pipeline_evaluator.py:21-26 `
...
`evaluations/dd/tasks_batch/C3_molecule_optimization/des_01_code_optimizer_penalized_logp.json:scoring_logic `
...
`evaluations/dd/scorers/oracle_budget.py:60-68 `
...
`agentdir/ToolUniverse/_agent_core.py:225-257 `; `agentdir/ToolUniverse/_agent_core.py:265-282 `; `agentdir/ToolUniverse/_agent_core.py:200-206 `
...
`evaluations/dd/scorers/oracle_chem.py:508-520 `
...
`evaluations/dd/scorers/oracle_regulator.py:893-923 `; `evaluations/dd/scorers/oracle_regulator.py:1159-1163 `
...
`evaluations/dd/scorers/oracle_regulator.py:271-305 `
...
`front_web/src/lib/judge-service.js:122-126 `; `front_web/src/lib/judge-service.js:6 `; `front_web/src/lib/judge-service.js:50-55 `
...
`evaluations/dd/agents/prompts.py:14-24 `; `evaluations/dd/agents/prompts.py:26-53 `; `evaluations/dd/agents/prompts.py:56-58 `
...
`evaluations/dd/scorers/data/answer_pool.json:1-107 `; `evaluations/dd/examples/agent_c5_logp.py:42-55 `
...
`evaluations/dd/tasks_batch/C3_molecule_optimization/des_01_code_optimizer_penalized_logp.json:prompt `
...
`evaluations/dd/scorers/oracle_validity.py:35-53 `; `evaluations/dd/scorers/data/answer_pool.json:3-6 `
...
`evaluations/dd/scorers/data/failure_modes.json:229-239 `
...
`agentdir/ToolUniverse/prompts/scrna_t1_t10_onestep.txt:1-50 `; `agentdir/ToolUniverse/prompts/scrna_t1_t10_onestep.txt:8-16 `
...
`agentdir/ToolUniverse/prompts/spatial_t1_t11_onestep.txt:39-63 `
...
`agentdir/ToolUniverse/_agent_core.py:25-28 `; `agentdir/ToolUniverse/run_pipeline.py:49-53 `
...
`evaluations/dd/agents/init.py:37-54 `; `evaluations/dd/agents/providers.py:23-27 `
...
`evaluations/dd/scorers/oracle_regulator.py:836-886 `
...
`evaluations/dd/registry.py:61-70 `
...
`evaluations/dd/scorers/penalized_logp_scorer.py:79-86 `
...
`evaluations/dd/scorers/oracle_budget.py:109-123 `; `evaluations/dd/scorers/oracle_budget.py:196-225 `; `evaluations/dd/runners/design_runner.py:223-241 `
...
`evaluations/dd/scorers/oracle_budget.py:41-195 `
...
`evaluations/dd/scorers/data/failure_modes.json:17-18 `; `evaluations/dd/scorers/data/answer_pool.json:79-85 `
...
`evaluations/dd/scorers/guacamol_goal_scorer.py:73-74 `
...
`evaluations/dd/scorers/oracle_budget.py:364-380 `
...
`evaluations/dd/registry.py:99-145 `
...
`front_web/src/lib/judge-service.js:277-292 `; `front_web/src/lib/judge-service.js:269-274 `
...
`front_web/templates/pipeline_evaluator.py:714-730 `
...
`agentdir/ToolUniverse/_agent_core.py:225-344 `
...
`agentdir/ToolUniverse/run_pipeline.py:63-95 `
...
`agentdir/ToolUniverse/run_pipeline.py:176-234 `
...
`front_web/templates/pipeline_evaluator.py:65-79 `
...
`front_web/templates/pipeline_evaluator.py:90-104 `
...
`evaluations/cross_domain/evaluate_eqtl_compare.py:37-44 `
...
`evaluations/dd/scorers/design_scores.py:12-85 `
...
`front_web/evaluate.py:175-202 `; `evaluations/dd/evaluate.py:230-253 `
...
`front_web/templates/pipeline_evaluator.py:725-727 `
...
`evaluations/dd/runners/batch_runner.py:64-67 `
...
`evaluations/dd/runners/batch_runner.py:160-172 `
...
`evaluations/dd/scorers/oracle_budget.py:72-123 `
...
`evaluations/dd/scorers/guacamol_goal_scorer.py:111-113 `
...
`evaluations/dd/scorers/oracle_regulator.py:1106-1150 `
...
`evaluations/dd/scorers/oracle_budget.py:208-211 `
...
`evaluations/dd/scorers/oracle_budget.py:173-177 `
...
`evaluations/dd/scorers/oracle_regulator.py:615-700 `
...
`front_web/templates/pipeline_evaluator.py:833-834 `
...
`evaluations/dd/scorers/oracle_chem.py:626-638 `
...
`evaluations/dd/runners/design_runner.py:244-252 `
...
`evaluations/dd/runners/design_runner.py:347-441 `
...
`agentdir/ToolUniverse/run_pipeline.py:167-173 `
...
`agentdir/ToolUniverse/_agent_core.py:265-282 `
...
`agentdir/ToolUniverse/_agent_core.py:288-344 `
...
`agentdir/ToolUniverse/_agent_core.py:200-206 `
...
`front_web/src/lib/judge-service.js:88-89 `
...
`front_web/judge.config.json:147-282 `
...
`evaluations/ehr/target_sl.md:1 `; `evaluations/cross_domain/target_sl.md:1 `
...
`front_web/templates/pipeline_evaluator.py:827 `
...
`evaluations/dd/scorers/data/answer_pool.json:87-106 `
...
`front_web/templates/pipeline_evaluator.py:503-510 `
...
`front_web/judge.config.json:320-330 `
